<div class="page-main-header">
  <div class="main-header-right row">
    <div class="main-header-left d-lg-none">
      <div class="logo-wrapper"><a href="index-2.html"><img src="http://admin.pixelstrap.com/endless/assets/images/endless-logo.png" alt=""></a></div>
    </div>
    ...
    <div class="nav-right col p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle" src="http://admin.pixelstrap.com/endless/assets/images/dashboard/user.png" alt="header-user">
    ...
    <script id="result-template" type="text/x-handlebars-template">
      ...
      <div class="ProfileCard-realName"> Cedric </div>
      </div>
      </div>
    </script>
