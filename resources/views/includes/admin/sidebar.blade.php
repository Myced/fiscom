<div class="page-sidebar">
  ...
  <div class="sidebar custom-scrollbar">
    <div class="sidebar-user text-center">
      <div><img class="img-60 rounded-circle" src="http://admin.pixelstrap.com/endless/assets/images/user/1.jpg" alt="#">
    ...
    <ul class="sidebar-menu">
      <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Dashboard</span><span class="badge badge-pill badge-primary">6</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
          <li><a href="index-2.html"><i class="fa fa-circle"></i><span>Default</span></a></li>
